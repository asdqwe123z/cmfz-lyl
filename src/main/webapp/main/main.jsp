            ...
            success:function(data){
                $.each(data,function (index,first) {
                    ...
                    $.each(first.list,function (index1,second) {
                        cc+= "<div style='text-align: center'><a href='javascript:void(0)' class='easyui-linkbutton' data-options=\"iconCls:'"+second.iconCls+"',plain:true\" onclick=\"addTabs('" + second.title + "','" + second.url + "','" + second.iconCls + "')\">" + second.title + "</a></div>";
                    });
                    $('#aa').accordion('add', {
                        title: first.title,
